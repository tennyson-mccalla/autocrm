BEGIN; TRUNCATE public.ticket_assignments CASCADE; TRUNCATE public.queue_assignments CASCADE; TRUNCATE public.conversations CASCADE; TRUNCATE public.tickets CASCADE; TRUNCATE public.queues CASCADE; DELETE FROM public.users WHERE email IN ('admin@test.com', 'worker@test.com', 'customer@test.com');
--
...
INSERT INTO public.users VALUES ('1dd0be84-a817-4c73-aa79-e1b99c0baa16', 'admin@test.com', 'admin', NULL, '{}', '2025-01-25 00:34:51.378+00', '2025-01-25 00:34:51.379+00');
INSERT INTO public.users VALUES ('bb12933a-784a-4b7c-93d7-1daeb06d815f', 'worker@test.com', 'worker', NULL, '{}', '2025-01-25 00:34:51.467+00', '2025-01-25 00:34:51.467+00');
INSERT INTO public.users VALUES ('8fcb8bab-88b1-401e-bfd0-983ff58c7107', 'customer@test.com', 'customer', NULL, '{}', '2025-01-25 00:34:51.565+00', '2025-01-25 00:34:51.565+00');
